...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey('self', null=True, blank=True, verbose_name='父类目级别',related_name = 'sub_cat', on_delete=models.CASCADE)
...
class GoodsCategoryBrand(models.Model):
    ...
    name = models.CharField(default='', max_length=30, verbose_name='品牌')
...
class GoodsImage(models.Model):
    goods = models.ForeignKey(Goods, verbose_name='商品', related_name='iamges', on_delete=models.CASCADE)
